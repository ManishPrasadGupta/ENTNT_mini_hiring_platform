...
export default function Header({
  ...
  return (
    <nav className="fixed top-0 left-0 w-full h-14 flex items-center justify-between px-6 bg-gradient-to-b from-emerald-50 to-white/90 border-b shadow-md backdrop-blur z-50">
